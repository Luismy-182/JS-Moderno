...
function iniciarApp() {
    ...
    function mostrarRecetas(recetas) {
        ...
        recetas.forEach(receta => {
            ...
            recetaImagen.alt = `Imagen de receta ${strMeal}`;
            ...
            //llamar a un función para mandar el id del platillo
            recetaButton.onclick = function () {
                seleccionarReceta(idMeal ?? receta.id);
            }

            //inyectar codigo HTML Card
    ...
    function mostrarRecetaModal(receta) {
        ...
        //mostramos los ingredientes y cantidades en un UL Li
        const listGroup = document.createElement('LU');
